...
\section{自我评价}
\cvlistitem{熟悉高性能网站架构和大数据处理架构。}
\cvlistitem{精通JAVA及相关技术，熟悉前端开发相关技术和 Android 移动端开发。}
\cvlistitem{熟悉测试驱动和敏捷开发，熟悉大型软件的开发发布流程。}
\cvlistitem{能以英语熟练交流。}

\section{工作经验}
\cventry{2016.5至今}{技术总监}{青岛国数信息科技有限公司}{}{}{
  \begin{itemize}
  \item 负责软件架构设计
...
\end{itemize}}
\cventry{2013.4--2016.4}{Tech Lead}{通联数据有限公司（DataYes）}{}{}{
  \begin{itemize}
