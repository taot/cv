...
\jobentry
	...
	{Working on the development and maintainence of the MEhome website.} % Description
	\begin{itemize}
        \item Import realty listing data from various data sources and do the data cleaning.
        \item Write frontend web pages / mobile app and backend services with PHP and VueJS.
        \item Designed the new data system based on Elastic Search, and pushed through the refactor of realty listing map and search functionality, which improved the performance and user experience.
    \end{itemize}
