...
\begin{supertabular}{r l} % Start a table with two columns, the table will ensure everything is aligned
	...
	\tableentry{}{AWS, AliCloud, JIRA, Agile}{spaceafter}
...
\jobentry
	...
	\begin{itemize}
        \item Designed and implemented the Portfolio Management System in Java, Spring, MySQL and related technologies.
