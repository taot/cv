...
\parbox[][0.11\textheight][c]{\linewidth}{ % Box to hold your name and CV title; change the fixed height as needed to match the colored box to the right
	...
	{\Large\textcolor{headings}{Software Engineer}}
...
\begin{supertabular}{r l} % Start a table with two columns, the table will ensure everything is aligned
    \tableentry{Legal Name}{Tao Tao}{spaceafter}
	...
	\tableentry{Experience}{11 years}{spaceafter}
\end{supertabular}
...
\begin{supertabular}{r l} % Start a table with two columns, the table will ensure everything is aligned
	...
	\tableentry{}{Java (the most fluent), C/C++, Scala, Javascript, Python, PHP}{spaceafter}
	\tableentry{}{MySQL, Elastic Search, MongoDB}{spaceafter}
	\tableentry{}{Spring Framework, Laravel, VueJS}{spaceafter}
	\tableentry{}{AWS, AliCloud, Restful, Docker, Microservice}{spaceafter}
	\tableentry{}{JIRA, Agile, Scrum, Git}{spaceafter}
...
\jobentry
	...
	\begin{itemize}
        ...
        \item Improve the performance and user experience of the website by optimizing code design, database queries, etc.
...
\jobentry
	...
	\begin{itemize}
        \item Designed and implemented the Portfolio Management System in Java, Scala, Spring, MySQL and related technologies.
        \item Exposed APIs to users and other products in the company.
        \item Communicate and coordinate with Product Manager and other teams.
    \end{itemize}
...
\jobentry
	...
	{Worked on the medical document download service implemented in Java/Scala and MongoDB. Designed and implemented the new user system, and migrated the website from the old one. Built the user data tracking system, and analyzed the user data.} % Description
